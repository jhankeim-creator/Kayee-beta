    ...
    <footer className="bg-[#1a1a1a] text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/shop/fashion" className="text-gray-400 hover:text-[#d4af37]">
                  Fashion
                </Link>
              </li>
              <li>
                <Link to="/shop/jewelry" className="text-gray-400 hover:text-[#d4af37]">
                  Jewelry
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="mailto:support@luxeboutique.com" className="text-gray-400 hover:text-[#d4af37] flex items-center">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm text-gray-400">
          <p>&copy; {new Date().getFullYear()} LuxeBoutique. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );

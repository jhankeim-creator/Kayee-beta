...
## 🌐 URL du site
**Site web:** https://replica-store-1.preview.emergentagent.com
...
### Étapes:
1. Allez sur : https://replica-store-1.preview.emergentagent.com/admin
2. Connectez-vous :
   ```
...
### Étapes:
1. Allez sur : https://replica-store-1.preview.emergentagent.com/admin/login
...
### Tester l'API Plisio:
```bash
curl -X POST "https://replica-store-1.preview.emergentagent.com/api/payments/plisio/create" \

...
## 🌐 URL du site
**Site web:** https://jewel-store-9.preview.emergentagent.com
...
### Étapes:
1. Allez sur : https://jewel-store-9.preview.emergentagent.com/admin
2. Connectez-vous :
   ```
...
### Étapes:
1. Allez sur : https://jewel-store-9.preview.emergentagent.com/admin/login
...
### Tester l'API Plisio:
```bash
curl -X POST "https://jewel-store-9.preview.emergentagent.com/api/payments/plisio/create" \

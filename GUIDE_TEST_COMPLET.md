...
## 🌐 URL du site
**Site web:** https://easycart-32.preview.emergentagent.com
...
### Étapes:
1. Allez sur : https://easycart-32.preview.emergentagent.com/admin
2. Connectez-vous :
   ```
...
### Étapes:
1. Allez sur : https://easycart-32.preview.emergentagent.com/admin/login
...
### Tester l'API Plisio:
```bash
curl -X POST "https://easycart-32.preview.emergentagent.com/api/payments/plisio/create" \
